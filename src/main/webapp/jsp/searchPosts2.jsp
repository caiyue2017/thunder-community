                    ...
                    <div class="text">
                        <c:if test="${sessionScope.user != null}">
                            ...
                            <shiro:hasRole name="user">
                                <a href="/jsp/user/userIndex.jsp" target="_blank">个人主页</a>
                            </shiro:hasRole>
                            <shiro:hasRole name="admin">
                                <a href="/jsp/user/admin2.jsp" target="_blank">管理页面</a>
                            </shiro:hasRole>
                            <%--<button type="button" onclick="logout()">注销</button>--%>
                        </c:if>
                        <c:if test="${sessionScope.user == null}">
                            <a href="/jsp/user/login.jsp" target="_blank" class="bt">登录</a>
                            <%--<a href="/jsp/user/register.jsp" target="_blank">注册</a>--%>
                        </c:if>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="title">
            ...
            <div class="description">
                ...
                <div class="cRight">
                    ...
                    <ul>
                        <li><a href="">这都是命？雷霆系列赛大部分时间领先火箭结果却1-3落后</a></li>
                        <li><a href="">差点露点，吉布森都笑了！韦少这低胸装什么水平？</a></li>
                        <li><a href="">没想到你是这样的神龟！偷瞄美女被发现，回家要跪搓衣板？</a></li>
                        <li><a href="">不再空砍！韦少终于扬眉吐气</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="topic">
            <%--<div class="topicsTop" style="margin-bottom: -30px;">
                ...
                &lt;%&ndash;分页&ndash;%&gt;
                &lt;%&ndash;<div class="right" id="page"/>&ndash;%&gt;
            </div>--%>
            <div class="topics">
                <%--全部时间，默认时间，精华，...--%>
                <div class="thead">
